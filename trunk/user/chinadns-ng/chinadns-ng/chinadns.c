...
static char        g_remote_ipports[SERVER_MAXCOUNT][ADDRPORT_STRLEN] = {"119.29.29.29#53", "", "8.8.8.8#53", ""};
...
static void parse_command_args(int argc, char *argv[]) {
    ...
    if (chinadns_optarg) {
        ...
        build_socket_addr(AF_INET, &g_remote_skaddrs[CHINADNS1_IDX], "119.29.29.29", 53);
    }
    if (trustdns_optarg) {
