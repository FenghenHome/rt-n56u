...
struct nvram_pair router_defaults[] = {
	...
	{ "ss_gfwlist_url", "https://cdn.jsdelivr.net/gh/FenghenHome/filters@gh-pages/dnsmasq.gfw-domains.conf"},
	...
	{ "trojan_link", "https://cdn.jsdelivr.net/gh/FenghenHome/Padavan-build/ssp/trojan" },
	{ "v2_local_enable", "0" },
	{ "v2_local", "/tmp/xray" },
	{ "v2_link", "https://cdn.jsdelivr.net/gh/FenghenHome/Padavan-build/ssp/xray" },
	{ "ss_mode", "1" },
	{ "ss_server", "127.0.0.1" },
	{ "ss_server_port", "8989" },
	{ "ss_key", "Secret" },
